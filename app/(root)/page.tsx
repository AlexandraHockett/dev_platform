...
const questions = [
  {
    ...
    author: {
      _id: "1",
      name: "Joahn",
      image: "https://cdn.pixabay.com/photo/2023/03/31/05/52/avatar-7889246_1280.jpg",
    },
    upvotes: 10,
    answers: 5,
    views: 100,
  ...
  },
  {
    ...
    author: {
      ...
      name: "Lua",
      image:
        "https://easy-peasy.ai/cdn-cgi/image/quality=80,format=auto,width=700/https://fdczvxmwwjwpwbeeqcth.supabase.co/storage/v1/object/public/images/b94eafde-25f5-41ff-a6c4-63786bf80377/5602cc0f-4caf-460b-8b30-84eb53ad6527.png",
    },
    upvotes: 10,
    answers: 5,
    views: 100,
